...
BEGIN
    ...
    VALUES (1, N'Faturalar', N'LG_{FIRMA}_{DONEM}_INVOICE', N'period', N'invoice_header', N'{a}.CANCELLED = 0', 0, N'INV');
END

IF NOT EXISTS (SELECT 1 FROM dbo.LogicalSource WHERE Id = 2)
BEGIN
    INSERT INTO dbo.LogicalSource (Id, DisplayName, PhysicalPattern, Scope, Grain, DefaultFilters, IsHidden, Alias)
    VALUES (2, N'Cari', N'LG_{FIRMA}_CLCARD', N'firm', N'card', NULL, 0, N'CLC');
END
...
IF NOT EXISTS (SELECT 1 FROM dbo.Field WHERE SourceId = 1 AND PhysicalColumn = N'FICHENO')
BEGIN
    INSERT INTO dbo.Field (SourceId, PhysicalColumn, DisplayName, DataType, Format, Role, DefaultAgg, IsHidden)
    VALUES (1, N'FICHENO', N'Fatura No', N'string', NULL, N'dimension', NULL, 0);
END

IF NOT EXISTS (SELECT 1 FROM dbo.Field WHERE SourceId = 1 AND PhysicalColumn = N'DATE_')
BEGIN
    INSERT INTO dbo.Field (SourceId, PhysicalColumn, DisplayName, DataType, Format, Role, DefaultAgg, IsHidden)
    VALUES (1, N'DATE_', N'Tarih', N'date', N'dd.MM.yyyy', N'dimension', NULL, 0); -- TODO: DATE_ int YYYYMMDD, tarih dilimine kadar working'i etkilemez
END

IF NOT EXISTS (SELECT 1 FROM dbo.Field WHERE SourceId = 1 AND PhysicalColumn = N'NETTOTAL')
BEGIN
    INSERT INTO dbo.Field (SourceId, PhysicalColumn, DisplayName, DataType, Format, Role, DefaultAgg, IsHidden)
    VALUES (1, N'NETTOTAL', N'Net Tutar', N'decimal', N'#,##0.00', N'measure', N'sum', 0);
END

IF NOT EXISTS (SELECT 1 FROM dbo.Field WHERE SourceId = 1 AND PhysicalColumn = N'CLIENTREF')
BEGIN
    INSERT INTO dbo.Field (SourceId, PhysicalColumn, DisplayName, DataType, Format, Role, DefaultAgg, IsHidden)
    VALUES (1, N'CLIENTREF', N'CLIENTREF', N'int', NULL, N'dimension', NULL, 1);
END

IF NOT EXISTS (SELECT 1 FROM dbo.Field WHERE SourceId = 1 AND PhysicalColumn = N'LOGICALREF')
BEGIN
    INSERT INTO dbo.Field (SourceId, PhysicalColumn, DisplayName, DataType, Format, Role, DefaultAgg, IsHidden)
    VALUES (1, N'LOGICALREF', N'LOGICALREF', N'int', NULL, N'dimension', NULL, 1);
END
...
BEGIN
    INSERT INTO dbo.Field (SourceId, PhysicalColumn, DisplayName, DataType, Format, Role, DefaultAgg, IsHidden)
    VALUES (2, N'CODE', N'Cari Kodu', N'string', NULL, N'dimension', NULL, 0);
END

IF NOT EXISTS (SELECT 1 FROM dbo.Field WHERE SourceId = 2 AND PhysicalColumn = N'DEFINITION_')
BEGIN
    INSERT INTO dbo.Field (SourceId, PhysicalColumn, DisplayName, DataType, Format, Role, DefaultAgg, IsHidden)
    VALUES (2, N'DEFINITION_', N'Cari Ünvan', N'string', NULL, N'dimension', NULL, 0);
END

IF NOT EXISTS (SELECT 1 FROM dbo.Field WHERE SourceId = 2 AND PhysicalColumn = N'LOGICALREF')
BEGIN
    INSERT INTO dbo.Field (SourceId, PhysicalColumn, DisplayName, DataType, Format, Role, DefaultAgg, IsHidden)
    VALUES (2, N'LOGICALREF', N'LOGICALREF', N'int', NULL, N'dimension', NULL, 1);
END
GO
...
BEGIN
    ...
    VALUES (1, 2, N'CLIENTREF', N'LOGICALREF', N'one_to_many', N'left');
END
GO
